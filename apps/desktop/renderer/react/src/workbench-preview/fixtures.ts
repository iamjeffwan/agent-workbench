...
const snapshotFailure: PreviewRecord = {
  ...
  file: 'packages/codex-adapter/src/task-evidence.ts',
...
export const previewRecords: PreviewRecord[] = [
  {
    ...
    rawRecord: { source: 'codex', sessionId: '019fc509', sequence: 36, status: 'completed' },
  ...
  },
  {
    ...
    rawRecord: { source: 'codex', event: 'patch_apply_end', status: 'error', sequence: 44 },
    children: [],
  },
  {
    id: 'code-changes',
  ...
  return (
    ...
    rawRecord: {
      ...
      observationWindow: {
        ...
        generationId: 'preview-codex-turn',
      },
    },
    detailMode: 'files',
  },
